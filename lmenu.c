...
void help_about ()
{
	printf ("Primality Testing of k*b^n+/-1 Program - PC/MacIntel beta Version 3.8.13\n");
	printf ("Using new Gwnum library (V28.5 beta) and IBDWT for k's up to 22 bits\n"); 
	printf ("(Copyright 1996-2014 Just For Fun Software, Inc.\n");
	printf ("Author: George Woltman\n");
	printf ("Email:  woltman@alum.mit.edu)\n");
	printf ("Written : February 20014 by Jean Penne\n");
