...
void help_about ()
{
	printf ("Primality Testing of k*2^n±1 Program - All PC's Version 3.7.0\n");
	printf ("Using new Gwnums library (V24.14) and IBDWT for k's up to 20 bits\n"); 
	printf ("(Copyright 1996-2005 Just For Fun Software, Inc.\n");
	printf ("Author: George Woltman\n");
	printf ("Email:  woltman@alum.mit.edu)\n");
	printf ("Written : March 2006 by Jean Penné\n");
	printf ("Email : jpenne@wanadoo.fr\n");
	askOK ();
}
