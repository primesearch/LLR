...
//	printf ("num_big_words = %lu, total_length = %lu, ratio = %7.5f\n", num_big_words, total_length, num_big_words/total_length); 
...
//	gwdata->EXTRA_BITS = (unsigned long)
//		intpow (2.0, (gwdata->fft_max_bits_per_word - virtual_bits_per_word (gwdata)) / 2.0);
...
//	raw_gwsetaddin (gwdata, word, value * intpow ((double) gwdata->b, b_in_word));
}
