	...
	unsigned long j)
{
	...
	result =  (double) ((uint32_t)(tmp2 >>32)*4294967296.0);	// VC6 cannot convert from uint64_t to double... JP 14/05/21
	result +=  (double)(uint32_t)(tmp2 &  0xFFFFFFFF);			// VC6 cannot convert from uint64_t to double... JP 14/05/21
